 ...
 * @method \Admin\Model\Entity\Option|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class OptionsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('name')
            ->maxLength('name', 50, '别称超出长度')
            ->allowEmptyString('name');

        $validator
            ->scalar('field')
            ->maxLength('field', 50, '字段key超出长度')
 ...
 * */
    ...
    * 获取所有数据  以数组形式返回
    * */
    public function getArrayData($conditions = [])
    {
