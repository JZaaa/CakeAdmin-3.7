<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<?php echo $this->Url->build(['plugin' => $this->request->getParam('plugin'), 'controller' => 'Users', 'action' => 'index']);?>" method="post" autocomplete="off">
