        ...
        <table class="table table-condensed table-hover">
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="icon" value="<?php echo h($data->icon);?>" size="35" class="form-control input-nm" >
                </td>
            </tr>
            <tr>
                <td>
                    <label for="name" class="control-label x85">菜单链接：</label>
                    <input type="text" name="target" value="<?php echo h($data->target);?>" size="35" class="form-control input-nm" >
                </td>
            </tr>
            <tr>
                <td>
                    <label for="name" class="control-label x85">菜单标识：</label>
                    <input type="text" name="reload" value="<?php echo h($data->reload);?>" size="35" class="form-control input-nm" >
                </td>
            </tr>
            <tr>
                <td>
